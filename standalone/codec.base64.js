...
Base64Codec.prototype = new Codec();
Base64Codec.prototype.constructor = Codec;
Base64Codec.prototype.baseClass = Codec.prototype.constructor;

Base64Codec.prototype.encode = function(inText) {
    return inText.encodeBase64();
}

Base64Codec.prototype.decode = function(inText) {
    return inText.decodeBase64();
}